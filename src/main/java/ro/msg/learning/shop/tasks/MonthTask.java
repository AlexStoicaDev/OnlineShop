...
public class MonthTask {
    ...
    public void createExcelAndStoreItInMongoDb() {
        final val productQuantityTotalRevenueForEachProductSoldMappedByDate = monthReportService.getProductQuantityTotalRevenueForEachProductSoldMappedByDate(LocalDateTime.now());
