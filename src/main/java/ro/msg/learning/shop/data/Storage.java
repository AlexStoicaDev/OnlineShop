...
public class Storage {
    ...
    public EntityCollection readEntitySetData(EdmEntitySet edmEntitySet) {
        ...
        if (edmEntitySet.getName().equals(EdmProvider.ES_ORDERS_NAME)) {
            return getOrders();
        }
        if (edmEntitySet.getName().equals(EdmProvider.ES_ORDERS_DETAILS_NAME)) {
    ...
    public Entity readEntityData(EdmEntitySet edmEntitySet, List<UriParameter> keyParams) throws ODataApplicationException {
        ...
        if (edmEntityType.getName().equals(EdmProvider.ET_ORDER_NAME)) {
            return getOrder(edmEntityType, keyParams);
        }
        if (edmEntityType.getName().equals(EdmProvider.ET_ORDER_DETAILS_NAME)) {
    ...
    private void initData() {
        ...
        productList = productRepository.findAll().parallelStream().map(product -> {
            ...
            e1.setType(EdmProvider.ET_PRODUCT_FQN.getFullQualifiedNameAsString());
    ...
    public Entity getRelatedEntity(Entity entity, EdmEntityType relatedEntityType, List<UriParameter> keyPredicates) throws ODataApplicationException {
        ...
        return EDMutil.findEntity(relatedEntityType, relatedEntities, keyPredicates);
    }
    ...
    public EntityCollection getRelatedEntityCollection(Entity sourceEntity, EdmEntityType targetEntityType) {
        ...
        if (sourceEntityFqn.equals(EdmProvider.ET_ORDER_DETAILS_FQN.getFullQualifiedNameAsString()) && relatedEntityFqn.equals(EdmProvider.ET_PRODUCT_FQN)) {
